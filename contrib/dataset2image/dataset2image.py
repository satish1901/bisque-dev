...
def update_references(sess, dataset_map, bisque_root=None, dryrun=False):
...
def main():
    ...
    if args.dataset_uniq.lower() == 'all':
        ...
        update_references(sess, dataset_map, bisque_root=args.server.rstrip('/'), dryrun=args.dryrun)
        if args.delete:
