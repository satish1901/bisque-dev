...
labels = np.loadtxt(synset_file, str, delimiter='\t')
...
resource = etree.Element('connoisseur', name="CaffeNet: natural image recognition" )
...
etree.SubElement(resource, 'tag', name="author", value="Berkeley Vision and Learning Center")
etree.SubElement(resource, 'tag', name="license", type="license", value="unrestricted")
etree.SubElement(resource, 'tag', name="copyright", type="copyright", value="Berkeley Vision and Learning Center")
etree.SubElement(resource, 'tag', name="description", value="This model is trained on natural images with 1000 classes")
etree.SubElement(resource, 'tag', name="thumbnail", value="thumbnail.svg")
...
etree.SubElement(a, 'tag', name="accept_gobjects", value="point", type="string,list")
etree.SubElement(a, 'tag', name="width", value="300", type="number")
etree.SubElement(a, 'tag', name="height", value="300", type="number")
...
for k,v in classes_test.iteritems():
    ...
    etree.SubElement(cc, 'tag', name='goodness', type="number,list", value=str(v['goodness']))
    ...
    etree.SubElement(cc, 'tag', name='MCC', type="number,list", value=str(v['MCC']))
