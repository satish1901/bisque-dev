Botanicam ReadMe.txt

The module is a re-implementation of the Botanicam done in Matlab. It is an demo of a python module using bisque's feature service and python api (bqapi). This module classifies with latest model file created by the Botanicam Trainer module.  
