...
def main(training_data_dir, testing_data_dir, output_data_dir):
    cell = cell_training(training_data_dir)
    ...
    for i,sample in enumerate(cell_test):
        ...
        file_name = os.path.splitext(file_name)[0]  #str(file_name[0:len(file_name)-1])
        img = sample['data']
        data = img[0,:,:,:]
        ...
        sitk.WriteImage(data, output_data_dir+file_name+'-matched.tif')

training_data_dir='data/PNAS/'
testing_data_dir='data/celldata/'
output_data_dir='hist_match/'

if __name__== "__main__":
    main(training_data_dir, testing_data_dir, output_data_dir)
