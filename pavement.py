...
def setup():
    ...
    sh('easy_install numpy==1.6.0')
    # End Hack
    sh('east_install http://biodev.ece.ucsb.edu/binaries/download/tw.output/tw.output-0.5.0dev-20110906.tar.gz') 
    ...
    sh('easy_install http://biodev.ece.ucsb.edu/binaries/depot/Paste/Paste-1.7.5.1bisque1.tar.gz')
